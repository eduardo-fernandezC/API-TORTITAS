...
public class DireccionService {
    ...
    public Direccion patch(Long id, Direccion direccion) {
        ...
        if (direccionToPatch != null) {
            if (direccion.getCalle() != null) direccionToPatch.setCalle(direccion.getCalle());
            if (direccion.getNumero() != null) direccionToPatch.setNumero(direccion.getNumero());
            if (direccion.getReferencia() != null) direccionToPatch.setReferencia(direccion.getReferencia());
            if (direccion.getComuna() != null) direccionToPatch.setComuna(direccion.getComuna());
            if (direccion.getUsuario() != null) direccionToPatch.setUsuario(direccion.getUsuario());
