...
public class PedidoService {
    ...
    public Pedido patch(Long id, Pedido pedido) {
        ...
        if (pedidoToPatch != null) {
            if (pedido.getFecha_pedido() != null) pedidoToPatch.setFecha_pedido(pedido.getFecha_pedido());
            if (pedido.getEstado() != null) pedidoToPatch.setEstado(pedido.getEstado());
            if (pedido.getTotal() != null) pedidoToPatch.setTotal(pedido.getTotal());
            if (pedido.getUsuario() != null) pedidoToPatch.setUsuario(pedido.getUsuario());
            if (pedido.getPago() != null) pedidoToPatch.setPago(pedido.getPago());
            if (pedido.getEnvio() != null) pedidoToPatch.setEnvio(pedido.getEnvio());
