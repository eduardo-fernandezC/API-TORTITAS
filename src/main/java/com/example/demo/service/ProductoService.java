...
public class ProductoService {
    ...
    public Producto patch(Long id, Producto producto) {
        ...
        if (productoToPatch != null) {
            if (producto.getNombre() != null) productoToPatch.setNombre(producto.getNombre());
            if (producto.getDescripcion() != null) productoToPatch.setDescripcion(producto.getDescripcion());
            if (producto.getPrecio() != null) productoToPatch.setPrecio(producto.getPrecio());
            if (producto.getStock() != 0) productoToPatch.setStock(producto.getStock());
            if (producto.getCategoria() != null) productoToPatch.setCategoria(producto.getCategoria());
            if (producto.getSabor() != null) productoToPatch.setSabor(producto.getSabor());
